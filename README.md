...
```
methodology/     36 candidates: 00_empty, 00_sabotage, a four-feature ladder, one idea each, two compositions, one transcribed kernel and its untranscribed source
