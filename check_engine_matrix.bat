...
if "!CX!"=="NONE" (echo   note codex not installed - e05_gpt_5_codex aborts with exit 6, as expected) else (echo   OK   codex -^> !CX!)
...
echo === configs ===
for %%C in (e06_local_gptoss_20b e07_local_qwen3_4b e08_local_qwen3coder_30b e02_claude_sonnet_5 e05_gpt_5_codex) do (
