GSD-B/L. 39_gsd_build_full cut to what a single run can obey: the same phase cycle, the same gate
...
against 36_gsd_core_lean, the question is whether four artefacts under `.planning/` behave differently
