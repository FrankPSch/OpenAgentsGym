<!-- mth_version: 40_gsd_surface_lean_outdated.v1 -->
...
`Get-Shit-Done Lean Methodology.md` §1 are written under `.planning/`, and no others — CONTEXT,
PLAN, SUMMARY, VERIFY per phase. A fifth is over-delivery. Review rounds: {{review_rounds=3}},
