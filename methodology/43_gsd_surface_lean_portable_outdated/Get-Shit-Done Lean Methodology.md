...
|---|---|---|
| `commands/gsd/` (67 md) | command entry points | prompt |
...
| `hooks/` (15 js/sh) | pre-action blocking, commit validation, injection scan, context monitor, statusline | **code** |
...
| **Blocking** enforcement (pre-action deny, commit validation, workflow guard) | not possible — advisory only | 2 |
