...
A method restated in prose: roughly thirty agent roles and some 120 reference documents' worth of
guidance, distilled into one document with 46 templates. What once ran as enforcement is restated
in §10 as standing discipline, which binds by being re-read rather than by refusing.
