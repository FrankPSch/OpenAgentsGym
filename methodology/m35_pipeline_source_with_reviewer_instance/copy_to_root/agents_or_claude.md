<!-- mth_version: m35_pipeline_source_with_reviewer_instance.v1 -->
...
| `../methodology/team_roles.md` | the roster, and the rules every role shares |
...
independent instance before it counts — the rule row in `../methodology/team_roles.md` says who names
the reader and where the verdict lands.
Here that reader is a separate instance you create with a fresh context, handed the task and the
change and nothing else; never review in your own context.
