<!-- mth_version: m38_pipeline_source_with_reviewer_relative_stop.v1 -->
...
**Every session reads the standard set, in this order, and nothing else unasked** — and, before it,
`../methodology/relative_stop.md`, which says when to stop:
