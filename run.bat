...
REM Capability level 2 (.llm_config.e02_claude_sonnet_5) unless the caller names another config.
if "%~3"=="" (set OPTS=--config .llm_config.e02_claude_sonnet_5) else (set OPTS=%3 %4)
