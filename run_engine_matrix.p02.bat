@echo off
REM ===========================================================================
REM The engine matrix for p02_python_medium, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.p02.bat            local engines, m00_empty
REM   run_engine_matrix.p02.bat 29_x       another methodology
REM   run_engine_matrix.p02.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" p02_python_medium %*
exit /b %ERRORLEVEL%
