@echo off
REM ===========================================================================
REM The engine matrix for p03_python_large, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.p03.bat            local engines, m00_empty
REM   run_engine_matrix.p03.bat 29_x       another methodology
REM   run_engine_matrix.p03.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" p03_python_large %*
exit /b %ERRORLEVEL%
