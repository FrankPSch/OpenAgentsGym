@echo off
REM ===========================================================================
REM The engine matrix for p05_python_refactor_large, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.p05.bat            local engines, m00_empty
REM   run_engine_matrix.p05.bat 29_x       another methodology
REM   run_engine_matrix.p05.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" p05_python_refactor_large %*
exit /b %ERRORLEVEL%
