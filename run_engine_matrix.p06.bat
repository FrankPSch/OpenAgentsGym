@echo off
REM ===========================================================================
REM The engine matrix for p06_qc_ema_cross, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.p06.bat            local engines, m00_empty
REM   run_engine_matrix.p06.bat 29_x       another methodology
REM   run_engine_matrix.p06.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" p06_qc_ema_cross %*
exit /b %ERRORLEVEL%
