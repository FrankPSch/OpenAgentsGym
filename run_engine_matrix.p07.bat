@echo off
REM ===========================================================================
REM The engine matrix for p07_qc_bugfix_refactor, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.p07.bat            local engines, m00_empty
REM   run_engine_matrix.p07.bat 29_x       another methodology
REM   run_engine_matrix.p07.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" p07_qc_bugfix_refactor %*
exit /b %ERRORLEVEL%
