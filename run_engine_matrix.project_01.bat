@echo off
REM ===========================================================================
REM Engine bring-up matrix: 01_python_small x 00_empty across engines/models.
REM
...
echo project=01_python_small methodology=00_empty >> "%SUMMARY%"
...
echo start %TIME%
py -3 run_master.py 01_python_small 00_empty --config .llm_config.%CFG% > "%LOGDIR%\%CFG%_%STAMP%.log" 2>&1
set "RC=!ERRORLEVEL!"
