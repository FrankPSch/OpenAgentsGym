@echo off
REM ===========================================================================
REM The engine matrix for 01_python_small, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_01.bat            local engines, 00_empty
REM   run_engine_matrix.project_01.bat 29_x       another methodology
REM   run_engine_matrix.project_01.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 01_python_small %*
exit /b %ERRORLEVEL%
