@echo off
REM ===========================================================================
REM Engine bring-up matrix: 02_python_medium x 00_empty across engines/models.
REM
...
echo project=02_python_medium methodology=00_empty >> "%SUMMARY%"
...
echo start %TIME%
py -3 run_master.py 02_python_medium 00_empty --config .llm_config.%CFG% > "%LOGDIR%\%CFG%_%STAMP%.log" 2>&1
set "RC=!ERRORLEVEL!"
