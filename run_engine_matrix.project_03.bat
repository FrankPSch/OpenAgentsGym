@echo off
REM ===========================================================================
REM The engine matrix for 03_python_large, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_03.bat            local engines, 00_empty
REM   run_engine_matrix.project_03.bat 29_x       another methodology
REM   run_engine_matrix.project_03.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 03_python_large %*
exit /b %ERRORLEVEL%
