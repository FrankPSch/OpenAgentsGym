@echo off
REM ===========================================================================
REM The engine matrix for 04_python_xlarge, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_04.bat            local engines, 00_empty
REM   run_engine_matrix.project_04.bat 29_x       another methodology
REM   run_engine_matrix.project_04.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 04_python_xlarge %*
exit /b %ERRORLEVEL%
