@echo off
REM ===========================================================================
REM The engine matrix for 05_python_refactor_large, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_05.bat            local engines, 00_empty
REM   run_engine_matrix.project_05.bat 29_x       another methodology
REM   run_engine_matrix.project_05.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 05_python_refactor_large %*
exit /b %ERRORLEVEL%
