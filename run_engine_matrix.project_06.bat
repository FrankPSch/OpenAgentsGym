@echo off
REM ===========================================================================
REM The engine matrix for 06_qc_ema_cross, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_06.bat            local engines, 00_empty
REM   run_engine_matrix.project_06.bat 29_x       another methodology
REM   run_engine_matrix.project_06.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 06_qc_ema_cross %*
exit /b %ERRORLEVEL%
