@echo off
REM ===========================================================================
REM The engine matrix for 07_qc_bugfix_refactor, with the no-methodology anchor.
REM
...
REM
REM USAGE
REM   run_engine_matrix.project_07.bat            local engines, 00_empty
REM   run_engine_matrix.project_07.bat 29_x       another methodology
REM   run_engine_matrix.project_07.bat /billed    also the two cloud legs
REM
...
REM ===========================================================================
call "%~dp0run_engine_matrix.bat" 07_qc_bugfix_refactor %*
exit /b %ERRORLEVEL%
